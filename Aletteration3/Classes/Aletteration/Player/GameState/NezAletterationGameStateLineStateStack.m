...
-(instancetype)init {
	if ((self = [super init])) {
		NSLog(@"NezAletterationGameStateLineStateStack init");
...
-(instancetype)initWithCoder:(NSCoder*)decoder {
	if ((self = [super init])) {
		NSLog(@"NezAletterationGameStateLineStateStack initWithCoder");
...
-(void)dealloc {
	NSLog(@"NezAletterationGameStateLineStateStack dealloc %ld", (long)self.count);
}
