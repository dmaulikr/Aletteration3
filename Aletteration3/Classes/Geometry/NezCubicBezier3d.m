...
@implementation NezCubicBezier3d

+(instancetype)bezier {
	GLKVector3 zero = GLKVector3Make(0, 0, 0);
	return [[NezCubicBezier3d alloc] initWithControlPointsP0:zero P1:zero P2:zero P3:zero];
}

+(instancetype)bezierWithControlPointsP0:(GLKVector3)p0 P1:(GLKVector3)p1 P2:(GLKVector3)p2 P3:(GLKVector3)p3 {
	return [[NezCubicBezier3d alloc] initWithControlPointsP0:p0 P1:p1 P2:p2 P3:p3];
}

+(instancetype)bezierWithControlPointsP0:(GLKVector3)p0 P1Z:(float)p1Z P2Z:(float)p2Z P3:(GLKVector3)p3 {
	return [[NezCubicBezier3d alloc] initWithControlPointsP0:p0 P1Z:p1Z P2Z:p2Z P3:p3];
}
...
+(instancetype)bezierWithControlPointsP0:(GLKVector3)p0 P1Z:(float)p1Z P1T:(float)p1T P2Z:(float)p2Z P2T:(float)p2T P3:(GLKVector3)p3 {
	return [[NezCubicBezier3d alloc] initWithControlPointsP0:p0 P1Z:p1Z P1T:p1T P2Z:p2Z P2T:p2T P3:p3];
}
