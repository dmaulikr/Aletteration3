//
//  NezVertexArrayFullScreenQuadGlow.m
//  Aletteration3
//
...
#import "NezVertexArrayFullScreenQuadGlow.h"
#import "NezAletterationGraphics.h"
#import "NezGLSLProgram.h"
#import "NezGLCamera.h"

@implementation NezVertexArrayFullScreenQuadGlow
...
-(void)drawWithGraphics:(NezAletterationGraphics*)graphics {
	...
	if (_texture0 && _texture1) {
		...
		glUniform1i(_program.u_texture1, 1);
	}
